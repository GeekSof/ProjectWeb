    ...
    <div class="wrapper">
        ...
        <section class="sidebar">
          ...
          <!-- Sidebar Menu -->
           <ul class="sidebar-menu">
            ...
            <li class="active"><a href="editaslider.php"><i class='fa fa-camera'></i> <span>Slider</span></a></li> 
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
         ...
         <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-camera"></i>Imagenes del Slider - Principal</a></li>
          </ol>
        </section>
            ...
            <div class="row">
              ...
              <div class="box">
                <div class="box-header with-border">
                      <i class="fa fa-camera"></i> <h3 class="box-title">Imagenes del Slider - Principal  </h3>
				...
				while ($archivo = readdir($dir)) {
                    ...
                    <tr >
                      ...
                      <td>
                          <form action='../controlador/valida.php'  method='POST' id="form2" enctype='multipart/form-data'>
                ...
                <div class="box-footer clearfix">
                    ...
                    <li><a>     <?php echo " Total de Archivos: $contArchivos";?></a></li>
                     ...
                     <div class="form-group">
                      ...
                      <form action='../controlador/valida.php' id="form3" method='post' enctype='multipart/form-data'>
                           <input type="hidden" name="accion" value="subeslider1">                           
                      <input type="file" required name="archivo" id="exampleInputFile">
                      <p class="help-block">Dimensiones: 783 x 361 px en formato jpg o png</p><br> 
                      <label for="exampleInputFile">Programa</label>
                      <select name="progra" required>
                          <option></option>
                          <?php 
                       $res2=$cn->prepare("call allprogra");
                                   $res2->execute();
                                   foreach ($res2 as $row){
                      ?>
