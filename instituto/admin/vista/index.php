<?php
    ...
    $nomusu=$_SESSION['nomusu'];
      if(isset($_SESSION['lista'])){
        ...
        header('Location: ../controlador/controlador.php?op=3');
    ...
    <div class="wrapper">
      ...
      <header class="main-header">
       ...
       <a href="index.php" class="logo">
          ...
          <span class="logo-mini"><img src="../../assets/img/logo2.png"></span>
        ...
        <section class="sidebar">
          ...
          <!-- Sidebar Menu -->
           <ul class="sidebar-menu">
            ...
            <li class="active"><a href="index.php"><i class='fa fa-institution'></i> <span>INCISPP</span></a></li>
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
         ...
         <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-graduation-cap"></i>Nosotros</a></li>            
          </ol>
        </section>
           ...
           <div class="row">
               <div class="col-xs-12">
                ...
                <div class='box-header'>
                  <h3 class='box-title'>INCISPP <small> Nosotros - Misión - Visión</small></h3>
                  <!-- tools box -->
                ...
                <div class='box-body pad'>
                  <form id="form1"   action="../controlador/valida.php" method="post">
                      <input type="hidden" name="accion" value="edtincispp">
                    <textarea class="ckeditor" id="editor1" name="editor1" rows="10" cols="80">
                      ...
                      <button class="btn btn-block btn-success" onclick="CKupdate();" id="bnt1" type="submit" name="btn1">Actualizar</button>
                  </form>
                </div>
              </div><!-- /.box -->
        </div></div>
