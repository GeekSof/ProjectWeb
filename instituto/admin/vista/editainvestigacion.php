<?php
    ...
    $nomusu=$_SESSION['nomusu'];
     if(isset($_SESSION['lista5'])){
        $lista5=$_SESSION['lista5'];
    }else{
            ...
            <div class="row" id="formulariohide">
             ...
             <div class="box box-primary">
                <div class="box-header with-border">
                 <i class="fa fa-user-plus"></i>  <h3 class="box-title">Editar</h3>
                </div><!-- /.box-header -->
                <!-- form start -->
                <form role="form" enctype='multipart/form-data' method="post"  action="../controlador/valida2.php" >
                    <input type="hidden" name="accion" value="editainvesti">
                    <input type="hidden" name="cod" value="<?php echo $row[0] ?>">
                  <div class="box-body">
                    <div class="form-group">
                      <label>Titulo</label>
                      <input name="nom" required type="text" class="form-control" id="exampleInputEmail1" value="<?php echo $row[1] ?>">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <p class="help-block">Procure que no sea uno foto muy grande.</p>
                    </div>
                  </div><!-- /.box-body -->
