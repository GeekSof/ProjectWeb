<?php
    ...
    if(isset($_SESSION['lista4'])){
        $lista4=$_SESSION['lista4'];
    }else{
        header('Location: ../controlador/controlador.php?op=6');
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
         ...
         <ol class="breadcrumb">
            ...
            <li class="active">Todos los Programas</li>
          </ol>
        </section>
        ...
        <section class="content">
            <div class="row">
                ...
                <?php 
                 foreach ($lista4 as  $rew){
                ?>
                   <form  action="../controlador/valida.php" enctype='multipart/form-data' method="post">
                       <input type="hidden" name="accion" value="editaprograma">
                        <input type="hidden" name="cod" value="<?php echo $rew[0] ?>">
                  <div class="box-body">
                    <div class="form-group">
                      <label for="exampleInputEmail1">Nombre</label>
                      <input type="text" class="form-control" name="nom" required placeholder="Ingrese un Nombre" value="<?php echo $rew[1] ?>">
                    </div>
                    <div class="form-group">
                  ...
                  <div class="box-footer">
                    <button onclick="CKupdate();" type="submit" class="btn btn-primary pull-right">Actualizar</button>
                  </div>
                </form>
           <?php 
                 }
