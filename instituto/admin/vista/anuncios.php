    ...
    <div class="wrapper">
           ...
           <ul class="sidebar-menu">
            ...
            <li><a href="editaslider2.php"><i class='fa fa-camera'></i> <span>Slider 2</span></a></li> 
             ...
             <li><a href="lemayredes.php"><i class='fa fa-tag'></i> <span>Lema y Redes Sociales</span></a></li>
              <li class="active"><a href="anuncios.php"><i class='fa fa-volume-up'></i> <span>Anuncios</span></a></li>
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
         ...
         <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-volume-up"></i>Anuncios</a></li>            
          </ol>
        </section>
           ...
           <div class="row">
               <div class="col-xs-12">
                ...
                <div class='box-header'>
                  <i class="fa fa-volume-up"></i><h3 class='box-title'>Anuncios</h3>
                  <!-- tools box -->
                ...
                <div class='box-body pad'>
                  <form id="form1"   action="../controlador/valida2.php" method="post">
                      <input type="hidden" name="accion" value="editaanuncio">
                        <?php
                                   $res=$cn->prepare("call lisanuncuio");
                                  $res->execute();
                        foreach ($res as $row){
                    ...
                    <?php if($row[1]=='A'){ ?>
                     <a class="btn btn-danger pull-left" href="../controlador/valida2.php?est=D&accion=estado">Desactivar</a>                     
                     <?php  }else{?>
                    <a class="btn btn-success pull-left" href="../controlador/valida2.php?est=A&accion=estado">Activar</a>
                     <?php }  }?>
                      <button class="btn btn-info pull-right" onclick="CKupdate();" id="bnt1" type="submit" name="btn1">Actualizar</button>
                  </form>
                </div>
              </div><!-- /.box -->
        </div></div>
