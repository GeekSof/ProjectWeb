    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
         ...
         <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-file-movie-o"></i>Álbumes</a></li>
          </ol>
        </section>
        ...
        <section class="content">
            <div class="row">
                ...
                <div class="box-header">
                    <i class="fa fa-file-movie-o"></i> <h3 class="box-title">Álbumes</h3>
                </div><!-- /.box-header -->
                ...
                <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td align="center"><img class="img-responsive imgchica" src="../../vista/assets/img/albumes/<?php  echo $row[2]?>" ></td>
                        <td align="center"> 
                            <a class="btn btn-danger" href="../controlador/valida2.php?accion=borraalbum&codalb=<?php echo $row[0];?>">Eliminar</a>
                             <a class="btn btn-info" href="detaalbum.php?codalb=<?php echo $row[0];?>">Ver Contenido</a>
          ...
          <?php echo 'http://incispp.edu.pe/controlador/controlador.php?op=5&codi='.$row[0]?>
            ...
            <div class="row" id="formulariohide">
             ...
             <div class="box box-primary">
                ...
                <!-- form start -->
                <form id="multimedia" role="form" enctype='multipart/form-data' method="post"  action="../controlador/valida2.php" >
                    <input type="hidden" name="accion" value="newalbum">
                  <div class="box-body">
                    ...
                    <div class="form-group">
                      ...
                      <p class="help-block">Dimensiones: 232 x 106 px en formato jpg</p>
                    </div>
                  </div><!-- /.box-body -->
