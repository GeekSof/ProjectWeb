    ...
    <div class="wrapper">
      ...
      <header class="main-header">
       ...
       <a href="index.php" class="logo">
          ...
          <span class="logo-mini"><img src="../../vista/assets/ico/logo2.png"></span>
          <!-- logo for regular state and mobile devices -->
          <span class="logo-lg"><img src="../../vista/assets/img/logo.png"></span>
        </a>
            ...
            <li ><a href="index.php"><i class='fa fa-institution'></i> <span>INCISPP</span></a></li>
             ...
             <li class="treeview active" >
              ...
              <ul class="treeview-menu">
                ...
                <li class="active"><a href="newprograma.php"><i class="fa fa-circle-o"></i>Nuevo</a></li>                
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
         ...
         <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-graduation-cap"></i>Programas Académicos</a></li>
            <li class="active">Nuevo Programa Académico</li>
          </ol>
        </section>
        ...
        <section class="content">
            <div class="row">
                ...
                <div class="box-header">
                    <i class="fa fa-users"></i> <h3 class="box-title">Nuevo Programa Académico</h3>
                </div><!-- /.box-header -->
                
                   <form  action="../controlador/valida.php" enctype='multipart/form-data' method="post">
                       <input type="hidden" name="accion" value="newprograma">
                  <div class="box-body">
                    <div class="form-group">
                      <label for="exampleInputEmail1">Nombre</label>
                      <input type="text" class="form-control" name="nom" required placeholder="Ingrese un Nombre">
                    </div>
                    <div class="form-group">
                      <label for="exampleInputPassword1">INFORMACIÓN</label>
                       <textarea class="ckeditor" id="editor1" name="editor1" rows="60" cols="80">
                                 
                    </textarea><br>
                    </div>
                      <div class="form-group">
                      <label for="exampleInputPassword1">MALLA CURRICULAR</label>
                       <textarea class="ckeditor" id="editor1" name="editor2" rows="60" cols="80">
                                 
                    </textarea><br>
                    </div>
                      <div class="form-group">
                      <label for="exampleInputPassword1">DOCENTES</label>
                       <textarea class="ckeditor" id="editor1" name="editor3" rows="60" cols="80">
                                 
                    </textarea><br>
                    </div>
                      <div class="form-group">
                      <label>Departamento</label>
                      <select name="codd" class="form-control">
                        <option>Seleccione un Departamento</option>
                        <?php 
                            $res=$cn->prepare('select * from departamentos');
                            $res->execute();
                            foreach ($res as  $row){
                        ?>
                      ...
                      <select name="codp" class="form-control">
                        ...
                        <?php 
                            $res=$cn->prepare('select * from programa');
                            $res->execute();
                            foreach ($res as  $row){
                        ?>
                        <option value="<?php echo $row[0] ?>"><?php echo $row[1] ?></option>
                    ...
                    <div class="form-group">
                      ...
                      <input type="file" name="foto2" >
                        <p class="help-block">Dimensiones: 800 x 1125 px, en formato jpg</p>
                    </div>
                  </div><!-- /.box-body -->
