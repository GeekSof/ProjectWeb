    ...
    <div class="wrapper">
           ...
           <ul class="sidebar-menu">
            ...
            <li><a href="editaslider2.php"><i class='fa fa-camera'></i> <span>Slider 2</span></a></li> 
             ...
             <li><a href="lemayredes.php"><i class='fa fa-tag'></i> <span>Lema y Redes Sociales</span></a></li>
              ...
              <li class="active"><a href="imagenes.php"><i class='fa fa-photo'></i> <span>Actualizar Imagenes</span></a></li>
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
         ...
         <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-camera"></i>Imagenes de la Pagina Web</a></li>
          </ol>
        </section>
            ...
            <div class="row">
              ...
              <div class="box">
                <div class="box-header with-border">
                      <i class="fa fa-camera"></i> <h3 class="box-title">Imagenes de la Pagina Web </h3>
                ...
                <div class="box-body table-responsive">
                  <table class="table table-bordered table-striped">
                    <tbody><tr>
                      <th>Nombre</th>
                      <th>Imagen</th>
                       <th>Dimensiones y formato</th>
                    </tr>
                    <tr>
                      <td>Logo</td>
                      <td align="center"><img   class="imgslider"
                       src="../../vista/assets/img/logo.png" >
                      </td>
                      <td>253 x 99 px en formato png</td>
                    </tr>
                    <tr>
                      <td>Departamentos</td>
                      <td align="center"><img   class="imgslider"
                       src="../../vista/assets/img/Departamentos.jpg" >
                      </td>
                      <td>1332 x 610 px en formato jpg</td>
                    </tr>
                    <tr>
                      <td>Fondo Editorial</td>
                      <td align="center"><img   class="imgslider"
                       src="../../vista/assets/img/Fondo Editorial.jpg" >
                      </td>
                      <td>1332 x 610 px en formato jpg</td>
                    </tr>
                    <tr>
                      <td>Multimedia</td>
                      <td align="center"><img   class="imgslider"
                       src="../../vista/assets/img/multimedia.jpg" >
                      </td>
                      <td>1332 x 610 px en formato jpg</td>
                    </tr>
                    <tr>
                      ...
                      <td align="center"><img   class="imgslider"
                       src="../../vista/assets/img/Campus virtual.jpg" >
                      </td>
                      <td>1332 x 610 px en formato jpg</td>
                    </tr>
                    <tr>
                      <td>Fondo de Contacto</td>
                      <td align="center"><img   class="imgslider"
                       src="../../vista/assets/img/contactar.jpg" >
                      </td>
                      <td>1920 x 1000 px en formato jpg</td>
                    </tr>
                  </tbody></table>
                </div><!-- /.box-body -->
                <div class="box-footer clearfix">           
                     <div class="form-group">
                      ...
                      <form action='../controlador/valida2.php' id="form3" method='post' enctype='multipart/form-data'>
                           <input type="hidden" name="accion" value="cambimagen">
                            <label for="exampleInputFile">Imagen</label><br>
                           <select name="nombre" required>
                               <option></option>
                               <option value="Campus virtual">Campus virtual</option>
                               <option value="Departamentos">Departamentos</option>
                               <option value="Fondo Editorial">Fondo Editorial</option>
                               <option value="multimedia">Multimedia</option>
                               <option value="logo">Logo</option>
                               <option value="contactar">Fondo de Contacto</option>
                           </select><br>
                           <label for="exampleInputFile">Archivo</label>
                      <input type="file" required name="archivo" id="exampleInputFile"><br>
