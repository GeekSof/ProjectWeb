<?php
    ...
    $nomusu=$_SESSION['nomusu'];
      if(isset($_SESSION['lista2'])){
        $lista2=$_SESSION['lista2'];
    }else{
        header('Location: ../controlador/controlador.php?op=4');
            ...
            <li ><a href="index.php"><i class='fa fa-institution'></i> <span>INCISPP</span></a></li>
             ...
             <li class="treeview active">
              ...
              <ul class="treeview-menu">
                ...
                <li class="active"><a href="../controlador/controlador.php?op=4"><i class="fa fa-circle-o"></i>Ver Todos</a></li>
              </ul>
            </li>
             <li class="treeview">
              <a href="#">
        ...
        <section class="content">
            <div class="row">
                ...
                <div class="box-header">
                    <i class="fa fa-users"></i> <h3 class="box-title">Programas Académicos</h3>
                </div><!-- /.box-header -->
                    ...
                    <tbody>
                      ...
                      <tr>
                        <td><?php echo $row[1]?></td>                    
                          <td align="center"><a class="btn btn-success" target="_blank" href="../programas/<?php  echo $row[8]?>">Ver</a></td>
                        <td align="center"><a class="btn btn-success" target="_blank" href="../programas/<?php  echo $row[9]?>">Ver</a></td>
                        <td> 
                            
                            <a class="btn btn-danger" href="../controlador/valida.php?accion=borraprograma&codcpro=<?php echo $row[0];?>">Eliminar</a>
                           <a class="btn  btn-facebook"  href="../controlador/controlador.php?codi=<?php echo $row[0];?>&op=6">Editar</a>
  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
        ...
        <div class="modal-body">
          <?php echo 'http://incispp.edu.pe/controlador/controlador.php?op=2&codi='.$row[0]?>
        </div>
      </div><!-- /.modal-content -->
  </div>
</div>
