    ...
    <div class="wrapper">
          ...
          <!-- Sidebar Menu -->
           <ul class="sidebar-menu">
            ...
            <li><a href="editaslider2.php"><i class='fa fa-camera'></i> <span>Slider 2</span></a></li> 
             ...
             <li class="active"><a href="docentes.php"><i class='fa fa-users'></i> <span>Plana Docente</span></a></li>
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
         ...
         <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-users"></i>Docentes</a></li>
          </ol>
        </section>
        ...
        <section class="content">
            <div class="row">
                ...
                <div class="box-header">
                    <i class="fa fa-users"></i> <h3 class="box-title">Docentes</h3>
                </div><!-- /.box-header -->
                <div class="box-body table-responsive">
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                        <?php
                                        $res=$cn->prepare("call listdocente");
                                         $res->execute();
                                        foreach ($res as $row){
                        ?>
                      <tr>
                        ...
                        <td align="center"><img class="img-responsive imgchica" src="../../vista/assets/img/team/<?php  echo $row[3]?>" ></td>
                        <td align="center"> 
                            
                            <a class="btn btn-danger" href="../controlador/valida2.php?accion=borradocente&codoc=<?php echo $row[0];?>">Eliminar</a>
                        </td>
                          <!-- Large modal -->
                      </tr>
                       <?php } ?>
                ...
                <div class="box-footer">
                       <input  class="btn btn-success" type='submit' name='boton' value='Ingresar Nuevo' onclick="muestraformulario();">
                       </div>
              </div><!-- /.box -->
                </div>
            </div>
            ...
            <div class="row" id="formulariohide">
             ...
             <div class="box box-primary">
                ...
                <form role="form" enctype='multipart/form-data' method="post"  action="../controlador/valida2.php" >
                    <input type="hidden" name="accion" value="newdocente">
                  <div class="box-body">
                    ...
                    <div class="form-group">
                      ...
                      <p class="help-block">Dimensiones: 725 x 348 px en formato jpg o png.</p>
                    </div>
                  </div><!-- /.box-body -->
