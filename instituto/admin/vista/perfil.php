    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
         ...
         <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-user"></i>Actualizar Datos de Usuario</a></li>
                ...
                <div class="col-lg-6">                                 
                    <div class="box box-info">
                            <div class="box-header with-border">
                                <i class="fa fa-user"></i><h3 class="box-title">Actualizar Datos de Usuario</h3>
                            </div>    
                        <?php
                        $cnx=new util();
                                   $cn=$cnx->getConexion();
                                   $res2=$cn->prepare("call lisperfil");
                                   $res2->execute();
                                            foreach ($res2 as $row){
                        ?>
                        <form id="formdatos" class="form-horizontal" action="../controlador/valida.php" method="post">
                            <input type="hidden" name="accion" value="actdatos">
                            <div class="box-body">
                                <div class="form-group">
                                    <label  class="col-sm-2 control-label">Nombre</label>
                                    <div class="col-sm-10">
                                        <input type="text"name="name" class="form-control" required value="<?php echo $row[1] ?>">
                                    </div>
                                </div>
                                <div class="form-group">
                                <label  class="col-sm-2 control-label">Usuario</label>
                                <div class="col-sm-10">
                                    <input type="email" class="form-control" name="email" required value="<?php echo $row[3] ?>">
                                </div>
                                </div>
                                <div class="form-group">
                                <label  class="col-sm-2 control-label">Contraseña</label>
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="pass" required value="<?php echo $row[4] ?>">
                                </div>
                                </div>
                            </div>
